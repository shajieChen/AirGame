...
ifeq ($(config),debug64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/AirGamed.exe
  DEFINES   += -D__orxDEBUG__
  INCLUDES  += -I$(ORX)/include -I../../../include/Scroll -I../../../include/imgui -I../../../include
...
$(OBJDIR)/AirGame.o: ../../../src/AirGame.cpp
	@echo $(notdir $<)
...
$(OBJDIR)/orxArchive.o: ../../../src/orxArchive.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"

$(OBJDIR)/orxImGui.o: ../../../src/orxImGui.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
